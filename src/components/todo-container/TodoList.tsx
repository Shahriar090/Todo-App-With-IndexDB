			...
			<ScrollArea className='h-[600px] pr-4'>
				<div className='space-y-4'>
					...
					{currentItems.map((todo: TodoType) => {
						const isCompleted = todo.completed === 1 ? true : false;
								...
								<div className={`p-6 transition-all duration-300 ${isExpanded ? 'pb-8' : ''}`}>
									...
									<div className='flex items-start gap-4'>
										...
										<button
											...
											className={`mt-1 flex-shrink-0 w-5 h-5 rounded-full border-2 cursor-pointer flex items-center justify-center transition-all duration-200 ${
												isCompleted
